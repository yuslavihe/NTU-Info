    ...
    <div className="bg-blue-50 border-l-4 border-ntu-blue p-4 rounded-r-lg my-6">
        <div className="flex">
            <div className="flex-shrink-0">
                <i data-lucide={icon} className="h-5 w-5 text-ntu-blue mt-1" aria-hidden="true"></i>
            </div>
            <div className="ml-3">
    ...
    return (
        <div className="bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                ...
                <Section icon="check-circle" title="1. Before You Arrive">
                    ...
                    <InfoCard icon="alert-triangle" title="Important Note on SG Arrival Card">
                ...
                <Section icon="plane-landing" title="2. Upon Arrival at Changi Airport">
                ...
                <Section icon="map-pin" title="3. Getting to NTU Campus">
                    ...
                    <InfoCard icon="ticket" title="EZ-Link / Nets FlashPay Card">
