...
import { CONCESSION_CARD_CONFIG } from '../constants/config.js';
...
const ConcessionCardCalculatorPage = () => {
    ...
    const handleCalculate = () => {
        ...
        const totalTripsPerMonth = tripsPerDay * travelDaysPerWeek * CONCESSION_CARD_CONFIG.WEEKS_IN_MONTH;
        const costWithoutConcession = totalTripsPerMonth * CONCESSION_CARD_CONFIG.AVG_FARE_PER_TRIP;
        const savings = costWithoutConcession - CONCESSION_CARD_CONFIG.MONTHLY_PASS_PRICE;

        setResult({
            eligible: true,
            costWithoutConcession: costWithoutConcession.toFixed(2),
            costWithConcession: CONCESSION_CARD_CONFIG.MONTHLY_PASS_PRICE.toFixed(2),
